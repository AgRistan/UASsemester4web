...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <a href="{{route('laporan.create')}}" class="btn btn-primary float-right"><i class="fas fa-fw fa-plus-circle"></i>Tambah Data</a>
                        ...
                        <td>
                            <div class="ml-4">
                                <form action="{{ route('laporan.destroy', $item->id )}}" method="POST">
                                    @csrf
                                    @method('delete')
                                    <a href="{{ route('laporan.edit', $item->id ) }}" class="btn bg-gradient-success btn-sm text-white"><i class="fas fa-fw fa-edit"></i></a>
